  ...
  if (roomState === 'PARTICIPANT') {
    ...
    return (
      <main className="relative flex h-screen flex-col overflow-hidden bg-bg pt-[env(safe-area-inset-top)] text-ink">
        ...
        <button
          className="absolute bottom-4 left-4 right-4 z-30 rounded-full border border-ink bg-filled px-5 py-3.5 text-sm font-medium text-on-ink shadow-[0_12px_28px_-8px_rgba(10,10,10,0.4)] transition hover:bg-transparent hover:text-ink sm:bottom-6 sm:left-auto sm:right-6 sm:w-auto"
        ...
        {/* ---- Message detail ---- */}
        {activeMessage && (
          <div className="fixed inset-x-0 top-0 z-50 flex h-screen flex-col bg-bg text-ink">
        ...
        {/* ---- Knock queue ---- */}
        {showQueue && (
          <div className="fixed inset-x-0 top-0 z-40 h-screen bg-overlay px-4 pb-6 pt-[max(1.5rem,env(safe-area-inset-top))]">
        ...
        {/* ---- Disband (destructive) ---- */}
        {showDisband && (
          <div className="fixed inset-x-0 top-0 z-40 flex h-screen items-center justify-center bg-black/60 px-6">
