  ...
  return (
    <main className="min-h-screen bg-[#f5f5f3] text-[#0a0a0a]">
      <div className="mx-auto flex max-w-xl flex-col gap-6 px-6 py-16">
        ...
        {status === 'form' && (
          <div className="rounded-[22px] border border-[#0a0a0a14] bg-white p-7">
            ...
            <button
              type="button"
              onClick={() => void create()}
              className="mt-6 w-full rounded-full border border-[#0a0a0a] bg-[#0a0a0a] py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-[#0a0a0a]"
            >
              Open channel
            </button>

            <p className="mt-4 text-center text-xs text-[#9a9a9a]">
              <a className="underline decoration-[#0a0a0a14] underline-offset-4 hover:text-[#0a0a0a]" href="/launch2/security/">
        ...
        {status === 'error' && (
          <div className="rounded-[22px] border border-[#b91c1c] bg-[#fee2e2] p-6 text-sm text-[#7f1d1d]">
            {error}
          </div>
        )}
      </div>
